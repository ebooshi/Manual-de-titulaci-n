...
\flushleft{
	\rotatebox{90}{
		\parbox{19cm}{
  			$\textit{let(prod(sum(w, num}[1] ),  \textit{num}[2]) \; [w := \textit{num}[2]], x.\textit{if(} \textit{ T, } w, \textit{ prod(num}[2], x)) \; [w := \textit{num}[2]] )$
		}
	}
}
\end{minipage}
...
\flushleft{
	\rotatebox{90}{
		\parbox{19cm}{
  			$\textit{let(prod(sum(w, num[1])} [w := \textit{num}[2]], 2 [\textit{var}[w] := 2]), x.\textit{if(} \textit{ T} [w := num[2]], w [w := \textit{num}[2]], \textit{ prod(num}[2], x\textit{)}[w := \textit{num}[2]] ))$
		}
	}
}
\end{minipage}
...
\flushleft{
	\rotatebox{90}{
		\parbox{19cm}{
			  $\textit{let(prod(sum(} w [w := \textit{num}[2]] , \textit{num}[1] [w := \textit{num}[2]] ), \textit{num}[2]), x.\textit{if(} \textit{ T, } \textit{num}[2], \textit{ prod(num}[2] [w := \textit{num}[2]], x [w := \textit{num}[2]])))$
		}
	}
}
\end{minipage}
