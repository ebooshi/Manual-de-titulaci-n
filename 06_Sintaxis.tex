...
De forma similar la sintaxis marca la pauta para la definición de funciones, como la función de evaluación para obtener el valor asociado a una expresión correctamente construida de un lenguaje de programación.  Al mismo tiempo será en esta estructura donde nos apoyaremos para definir los procesos de análisis para determinar la validez y el tipo de dichas expresiones.\\\\
...
\section{Sintaxis concreta}
    ...
    La sintaxis abstracta se relaciona con la abstracción de la estructura del lenguaje y comúnmente es definida mediante reglas de inferencia para construir un árbol sintáctico, donde cada nodo corresponde a una instrucción ó operador,
