...
\bigskip
    ...
    \begin{definition}
        Sea $\text{A} = \{ 0,1 \}$, definimos el tipo de dato recursivo $\text{A}^*$ \footnote{Definición formulada a partir de \hyperlink{67}{[67]}, \hyperlink{68}{[68]} y \hyperlink{69}{[69]}} como sigue: \\\\
            \[
                \begin{array}{lcl}    
...
\section{Estructuras recursivas e inducción estructural}
    ...
    En el caso del tipo de dato A*, el elemento más primitivo que pertenece a esta estructura es la cadena vacía (denotada como $\varepsilon$) o bien una tupla con cabeza \textit{a} A y cola de tipo A*.\\\\
