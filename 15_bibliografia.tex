\begin{thebibliography}{11}
   ...
   %http://www.dcc.ic.uff.br/~isabel/LP/D.Watt.pdf
    ...
    \label{sec:128}
    \hypertarget{128}{}
     Igarashi A. Pierce B. Wadler P., \textit{Featherweight Java: A Minimal Core Calculus for Java and GJ},  University of Tokyo, University of Pennsylvania. 2002.
    % https://www.cis.upenn.edu/~bcpierce/papers/fj-toplas.pdf

    \bibitem{}
    \label{sec:128}
    \hypertarget{128}{}
    Weirich S. Huang L., \textit{A Design for Type-Directed Programming in Java},  University of Pennsylvania. Estados Unidos. 2002.
