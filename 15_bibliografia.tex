...
%https://groups.seas.harvard.edu/courses/cs152/2016sp/schedule.html
    ...
    \label{sec:7}
    \hypertarget{7}{}
    F. Nielson, \textit{Semantics with Applications: An Appetizer, } Springer Publishing,  Berlin, 2007. [Online]. Available: https://archive.org/details/Hanne\_Riis\_Nielson\_Flemming\_Nielson\_\_Semantics
   % Available: https://archive.org/details/Hanne\_Riis\_Nielson\_Flemming\_Nielson\_\_Semantics\_with\_Applications.
    ...
    \label{sec:9}
    \hypertarget{9}{}
    J. Mitchell, \textit{Foundations for Programming Languages}, Massachusetts Institute of Technology Press, Cambridge, 1996.
    
    
    \bibitem{shriram}
    \label{sec:10}
    \hypertarget{10}{}
    S. Krishnamurthi, \textit{Programming Languages Application and Interpretation}, Brown University press, Rhode Island, 2007.
    ...
    \label{sec:20}
    \hypertarget{20}{}
    A. Goguen, \textit{Category Theory Applied to Computation and Control. Lecture Notes in Computer Science}, vol. 25. Springer, Berlin, 1975.

    \bibitem{21}
    \label{sec:21}
    \hypertarget{21}{}
    W. Floyd, \textit{Mathematical Aspects of Computer Science. Proceedings of Symposium on Applied Mathematics}, J.T. Schwartz, Ed., vol. 19. American Mathematical Society, 1967. [Online]. Available: https://www.cs.tau.ac.il/~nachumd/term/FloydMeaning.pdf.

    \bibitem{22}
    \label{sec:22}
    \hypertarget{22}{}
    G. Winskel, \textit{The formal semantics of programming languages: an introduction}, Massachusetts Institute of Technology Press, Cambridge, 1993. [Online]. Available: https://cin.ufpe.br/~if721/intranet/TheFormalSemanticsofProgrammingLanguages.pdf.
...
% Seguir buscando bibliografia
    ...
    \label{sec:25}
    \hypertarget{25}{}
    P. Deransart \textit{et al.}, \textit{Attribute Grammars: Definitions, Systems and Bibliography}, Lecture Notes in Computer Science 323. Springer-Verlag, Berlin, 1988.
    ...
    \label{sec:30}
    \hypertarget{30}{}
    P. Friedman \textit{et al.}, \textit{Essentials of Programming Languages}, 1st ed. The Massachusetts Institute of Technology Press, Cambridge, 1992.
    ...
    \label{sec:33}
    \hypertarget{33}{}
    C. Louden, \textit{Compiler Construction: Principles and Practice}, Brooks-Cole Publishers, United States, 1997.

    \bibitem{34}
    \label{sec:34}
    \hypertarget{34}{}
    M. Sipser, \textit{Introduction to the Theory of Computation}, PWS Publishing Co., United States, 1997.
    ...
    \label{sec:38}
    \hypertarget{38}{}
    Y. Winter, \textit{Flexibility principles in Boolean semantics}, Massachusetts Institute of Technology Press, Cambridge, 2001.

    \bibitem{39}
    \label{sec:39}
    \hypertarget{39}{}
    M. Felleisen \textit{et al.}, \textit{How to Design Programs}, 1st ed. Massachusetts Institute of Technology Press, Cambridge, 2003.
    ...
    \label{sec:41}
    \hypertarget{41}{}
    W. Levelt, \textit{An Introduction to the Theory of Formal Languages and Automata}, John Benjamins Publishing, United States, 2008.

    \bibitem{42}
    \label{sec:42}
    \hypertarget{42}{}
    E. Scott, \textit{SPPF-Style Parsing From Earley Recognizers,}\textit{Electronic Notes in Theoretical Computer Science}, Elsevier B.V., United Kingdom, 2008.
    ...
    \label{sec:48}
    \hypertarget{48}{}
    A. Martin \textit{et al.}, \textit{A Theory of Objects}. Springer Verlag, United States, 1998.
    ...
    \label{sec:56}
    \hypertarget{56}{}
    B. Eckel, \textit{Thinking in Java}. Pearson Education Publishers,  United States, 2006.
    ...
    \label{sec:59}
    \hypertarget{59}{}
    J. Azzouni, \textit{Metaphysical Myths, Mathematical Practice}. Cambridge University Press, United States, 1994.
:
    \bibitem{60}
    \label{sec:60}
    \hypertarget{60}{}
    J. Burgess \textit{et al.}, \textit{A Subject with No Object}, Oxford University Press,  United Kingdom, 1997.
    ...
    \label{sec:64}
    \hypertarget{64}{}
    G. Boolos \textit{et al.}, \textit{Computability and logic}. Cambridge University Press, United States, 2007.

    \bibitem{65}
    \label{sec:65}
    \hypertarget{65}{}
    C. R. John, \textit{Theories of Programming Languages}, Cambridge University Press, United States, 2009.
    
    \bibitem{66}
    \label{sec:66}
    \hypertarget{66}{}
    M. Bergmann, \textit{An introduction to many-valued and fuzzy logic: semantics, algebras, and derivation systems}, Cambridge University Press, United States, 2008.

    \bibitem{67}
    \label{sec:67}
    \hypertarget{67}{}
    F. Miranda \textit{et al.}, \textit{Matemáticas Discretas}, Facultad de Ciencias, Universidad Nacional Autónoma de México, Ciudad de México, 2016.

    \bibitem{68}
    \label{sec:68}
    \hypertarget{68}{}
    A. Dossey \textit{et al.}, \textit{Discrete Mathematics}, 5th ed. Pearson-Addison-Wesley Publishing Co., United States, 2006.

    \bibitem{69}
    \label{sec:69}
    \hypertarget{69}{}
    L. Gersting, \textit{Mathematical Structures for Computer Science}, 3rd ed. Computer Science Press, W.H. Freeman and Company,  United States, 1993.

    \bibitem{70}
    \label{sec:70}
    \hypertarget{70}{}
    K. Grassman \textit{et al.}, \textit{Logic and Discrete Mathematics, A computer Science Perspective}, Prentice-Hall Inc., United States, 1996.

    \bibitem{71}
    \label{sec:71}
    \hypertarget{71}{}
    D. Gries \textit{et al.}, \textit{A Logical Approach to Discrete Mathematics}, Springer-Verlag,  United States, 1994.

    \bibitem{72}
    \label{sec:72}
    \hypertarget{72}{}
    W. Grossman, \textit{Discrete Mathematics, An introduction to concepts, methods and applications}, Macmillan Publishing Company,  United States, 1990.
    ...
    \label{sec:77}
    \hypertarget{77}{}
    N. Chomsky, \textit{Aspects of the Theory of Syntax}, Massachusetts Institute of Technology Press, Cambridge, 2014.
    ...
    \label{sec:85}
    \hypertarget{85}{}
    C. Mitchell, \textit{Concepts in Programming Languages}, Cambridge University Press, Cambridge, 2003.

    \bibitem{86}
    \label{sec:86}
    \hypertarget{86}{}
    C. Pierce, \textit{Basic Category Theory for Computer Scientists}, The MIT Press, Cambridge, 1991.

    \bibitem{87}
    \label{sec:87}
    \hypertarget{87}{}
    A. Church, \textit{A set of postulates for the foundation of logic,}\textit{Annals of Mathematics Archive}, Series 2, vol. 33, no. 2, pp. 346–366, Mathematics Department, Princeton University Press, Nueva Jersey, 1932.

    \bibitem{88}
    \label{sec:88}
    \hypertarget{88}{}
    P. Selinger, \textit{Lecture Notes on the Lambda Calculus}, vol. 0804. Department of Mathematics and Statistics, University of Ottawa Press, Canada, 2018.

    \bibitem{89}
    \label{sec:89}
    \hypertarget{89}{}
    F. Turbak \textit{et al.}, \textit{Design concepts in programming languages}, The MIT press, Cambridge, 2008.
    ...
    \label{sec:92}
    \hypertarget{92}{}
    M. DeVos, \textit{Mathematical Induction}, University Press, Canada, 2023.

    \bibitem{93}
    \label{sec:93}
    \hypertarget{93}{}
    G. Diaz, \textit{Mathematical Induction}, Wayback Machine Archive, Harvard University Press, United States, 2023.
    ...
    \label{sec:95}
    \hypertarget{95}{}
    L. Causey, \textit{Logic, sets, and recursion}, 2nd ed. Jones and Bartlett Publishers, New England, 2006.
    ...
    \label{sec:97}
    \hypertarget{97}{}
    F. Remer, \textit{Compiler Construction course, } University of California Press, United States, 1979.
    ...
    \label{sec:99}
    \hypertarget{99}{}
    R. Cann \textit{et al.}, \textit{The dynamics of language: an introduction}, Elsevier, Amsterdam, 2005.
    ...
    \label{sec:101}
    \hypertarget{101}{}
    K. Gilles, \textit{Natural Semantics, }in \textit{Proceedings of the 4th Annual Symposium on Theoretical Aspects of Computer Science}, Springer-Verlag, United Kingdom, 1987.
    ...
    \label{sec:104}
    \hypertarget{104}{}
    B. Pierce \textit{et al.}, \textit{Programming Language Foundations}, The MIT Press,  Cambridge, 2021. [Online]. Available: https://softwarefoundations.cis.upenn.edu/plf-current/Smallstep.html. [Accessed: Apr. 30, 2024].
   ...
   %Available: https://github.com/jaeem006/Lenguajes/blob/main/Gabrielle\_exc/Semantics\_exercises\_sol.pdf.
    ...
    \label{sec:114}
    \hypertarget{114}{}
    G. Richards, \textit{Proof of the Church-Rosser Theorem, } Waterloo University Online Repository, Ontario, Canadá, 2022. [Online]. Available: https://student.cs.uwaterloo.ca/\text{~}cs442/W22/extras/c-r-thm-proof.pdf. [Accessed: Jun. 4, 2024].
    ...
    \label{sec:122}
    \hypertarget{122}{}
    D. Watt, \textit{Programming Language Design Concepts}, John Wiley \& Sons, Ltd., University of Glasgow, Scotland, 2004.
    ...
    \label{sec:135}
    \hypertarget{135}{}
    \textit{Lecture 18: Context-Free Grammars (CS103: Mathematical Foundations of Computing), } Stanford University, United States, 2016. [Online]. Available: https://web.stanford.edu/class/archive/cs/cs103/cs103.1164/lectures/18/Slides18.pdf.
