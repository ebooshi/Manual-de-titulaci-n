...
\begin{definition}[Pila de control] Una pila de control está formada a partir de marcos, y se define inductivamente como siguel\footnote{Definición formulada de  \hyperlink{5}{[5]}, \hyperlink{12}{[12]}, y \hyperlink{126}{[126]} }:
...
\end{definition}
\subsection{Estados}
\begin{definition}[Estados de la máquina $\Hs$] Los estados están compuestos de una pila de control $P$ y una expresión $e$ cerrada y son de alguna de las siguientes formas\footnote{Definición formulada de  \hyperlink{5}{[5]} y  \hyperlink{12}{[12]} }:
\bigskip
\begin{itemize}
