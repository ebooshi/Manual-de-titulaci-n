...
\textsf{Java Peso Pluma} es un lenguaje con propósitos ilustrativos, muchas de las características que rebostucen a \textsf{Java} y que son englobadas por el paradigma de la orientaciön a objetos se dejan fuera del enfoque de la definición del mismo. \\\\
...
\begin{itemize}
    ...
    \item Un programa sintácticamente correcto es tipable en \textsf{Java Peso Pluma} si y sólo si es tipable en \textsf{Java}.
    \item La ejecución de un programa bien tipado en \textsf{Java Peso Pluma} se comporta de la misma forma en \textsf{Java}.
