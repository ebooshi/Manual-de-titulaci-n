...
\subsection{Semántica operacional}
    ...
    \begin{definition}[Definición de cerradura transitiva y reflexiva]  Denotamos la aplicación de la función de transición n-veces como: $t\rightarrow^*$ que define las siguientes relaciones\footnote{Definición acuñada de \hyperlink{2}{[2]}, \hyperlink{5}{[5]} y  \hyperlink{12}{[12]}.}:
        \[
            \begin{array}{ccc}
