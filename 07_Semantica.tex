...
\bigskip
  ...
  \begin{definition}[Semántica estática para capturar expresiones con variables libres en \textsf{EAB}]
	...
	En este caso dos de las ramas en el árbol de derivación concluyeron en un error, pues si una variable es libre el jucio $\Delta\ \sim \ e$ no es válido. Concluimos entonces que la expresión no es correcta.
    \end{exercise}
