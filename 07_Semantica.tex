...
\bigskip
  ...
  \begin{definition}[Semántica estática para capturar expresiones con variables libres en \textsf{EAB}]
    ...
    \[
        \begin{array}{cc}
            \inference{}{\Delta\sim \textit{B}\ \text{ Bool}}[\textit{(fvb)}]&
...
Nuevamente hacemos abuso de la notación para denotar los operadores de \textsf{EAB}, representados como $ O(e_1,\cdots,e_n)$ y los booleanos $B\ Bool$
    \end{definition}
...
\subsection{Semántica operacional}
	...
	La semántica de paso pequeño y de paso grande comparten la definición de los estados difiriendo únicamente en la definición de la función de transición, esta será definida a continuación para cada enfoque.
    ...
    \begin{definition}[Función de transición para semántica de paso pequeño]
	Para definir las reglas de transición para los cómputos siguiendo el paradigma de semántica de paso pequeño, primero vamos a evaluar el argumento más a la izquierda dentro de las expresiones que denotan un operador hasta obtener un valor. Posteriormente evaluaremos el argumento a la derecha\footnote{Definición acuñada de \hyperlink{2}{[2]}, \hyperlink{5}{[5]},  \hyperlink{12}{[12]} y \hyperlink{105}{[105]}.}. \\
