...
\end{exercise}
        ...
        Observe que omitimos la definición entera de la sintaxis abstracta. El lector debe interpretar que cada programa escrito en \textsf{TinyC} tiene un mapeo a una representación con un árbol de sintaxis abstracta que estudiaremos con la introducción de los  marcos.
...
\begin{definition}Se definen los siguientes marcos que usaremos en la pila de control de la máquina $\Cs$l\footnote{Definición formulada de \hyperlink{5}{[5]}, \hyperlink{8}{[8]} y \hyperlink{12}{[12]} }
    \begin{description}
        \item[Declaraciones] 
            \[
                \begin{array}{c}
...
\subsection{Estados}
Esta Categoría supone una diferencia sustancial con las máquinas abstractas hasta ahora estudiadas. Tendremos una categoría para la pila de cómputos pendientes y dos categorías para el contexto de evaluación de las variables, el primero local representando el alcance de las variables declaradas en el cuerpo de una función y uno global para aquellas declaraciones cuyo contexto sea todo el programa.\\\\
\begin{definition}Los estados de la máquina $\Cs$ son de la siguiente forma\footnote{Definición formulada de \hyperlink{5}{[5]}, y \hyperlink{8}{[8]} }:
...
\begin{definition} Definimos la referencia de variables en el ambiente recursivamente como sigue\footnote{Definición formulada de \hyperlink{5}{[5]}, y \hyperlink{8}{[8]} }:
\[
    \begin{array}{ccccc}
...
\begin{definition}Definimos la modificación del ambiente recursivamente como sigue\footnote{Definición formulada de \hyperlink{5}{[5]}, y \hyperlink{8}{[8]} }:
\[
    \begin{array}{ccc}
...
\begin{description}
    ...
    \item[While]
        ...
        Observe como la expresión $while\,$ sigue apareciendo en el lado derecho. De esta forma se desdobla el ciclo tantas veces como se cumpla la condición.
    \item[Llamada a función]
        \[
            \begin{array}{c}
                \scalemath{0.9}{
