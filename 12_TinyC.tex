...
\begin{exercise}
    Utilizando la sintaxis definida para \textsf{TinyC} proporciona la definición del algoritmo mergeSort.
\end{exercise}
...
\begin{exercise}
    Utilizando la sintaxis definida para \textsf{TinyC} proporciona la definición del algoritmo binarySearch.
\end{exercise}

\bigskip

\begin{exercise}
    Utilizando la definición de la máquina C evalúa el ejercicio anterior con el arreglo [8,4,1,2,7] y 2
\end{exercise}
...
\begin{exercise}
    Utilizando la definición de la máquina C evalúa el ejercicio anterior con el arreglo 7
\end{exercise}
